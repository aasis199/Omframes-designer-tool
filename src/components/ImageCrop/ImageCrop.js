...
export default function CustomizedDialogs(props) {
  ...
  const handleChange = (e) =>
  {
   ...
   const handleSubmit =() => {
    if(completedCrop){
      document.getElementById('if_frame').classList.remove('init');
      document.getElementById('if_mount').classList.remove('init_mat');
    }
    document.getElementById('if_frame').style.display = "block";
